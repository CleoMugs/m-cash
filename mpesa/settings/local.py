...
SECRET_KEY = 'django-insecure-7ggv#%z8c96fhd-lz+vb!u%pdg(b-s9o*-mo6gt*oehp@+lo(w'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = (os.path.join(BASE_DIR, "staticfilesa"))
...
CCRS_REPLACE_HTTPS_REFERER = False
HOST_SCHEME = "http://"
